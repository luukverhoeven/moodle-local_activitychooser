        ...
        return new \external_multiple_structure(
            new \external_single_structure(
                [
                    ...
                    'courseid' => new \external_value(PARAM_INT, 'The id of course', VALUE_REQUIRED),
                    'section' => new \external_value(PARAM_INT, 'The section where the activity is located', VALUE_REQUIRED),
